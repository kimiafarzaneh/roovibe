    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          // w-[calc(100%-2rem)] = full width minus 16px each side on mobile
          // max-w-[425px] = caps at 425px on larger screens
          // max-h-[90dvh] = never taller than 90% of viewport
          // overflow-y-auto = scroll if content overflows
          "w-[calc(100%-2rem)] max-w-[425px]",
          "max-h-[90dvh] overflow-y-auto",
          // Appearance
          "grid gap-4 rounded-2xl bg-popover text-sm text-popover-foreground",
